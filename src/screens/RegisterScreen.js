...
export default function RegisterScreen({ navigation }) {
  ...
  const { isDesktop, hPad, fs, sp } = useResponsive();
  ...
  const handleRegister = async () => {
    ...
    try {
      ...
      showMessage('Error de Registro', msgs[error.code] || 'Ocurrió un error al registrar la cuenta.');
    }
  };
    ...
    >
      ...
      >
        <View style={[styles.card, isDesktop && styles.cardDesktop]}>
          ...
          <Text style={[styles.title, { fontSize: fs.xl }]}>Crear Cuenta</Text>
          ...
          <TouchableOpacity style={styles.button} onPress={handleRegister}>
            <Text style={[styles.buttonText, { fontSize: fs.md }]}>Registrarse</Text>
          </TouchableOpacity>

          <View style={styles.separator}>
            <View style={styles.line} />
            <Text style={[styles.separatorText, { fontSize: fs.sm }]}>o regístrate con</Text>
            <View style={styles.line} />
          </View>
          ...
          <TouchableOpacity onPress={() => navigation.navigate('Login')}>
            <Text style={[styles.linkText, { fontSize: fs.sm }]}>¿Ya tienes cuenta? Inicia sesión aquí</Text>
          </TouchableOpacity>
        </View>
      </ScrollView>
    </KeyboardAvoidingView>
